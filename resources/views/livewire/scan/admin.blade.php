...
<div class="w-full">
    <div class="flex gap-8">
        ...
        <div
            class="flex flex-col relative overflow-auto max-h-[575px] bg-white dark:bg-zinc-900 p-5 lg:p-8 rounded-xl shadow-xl w-full aspect-square">
            <h1 class="text-2xl font-bold text-zinc-800 dark:text-zinc-100 mb-1">
                {{ $this->event['name'] }}
            </h1>
            <p class="text-zinc-500 dark:text-zinc-400 text-sm mb-4 line-clamp-2">
