...
<div class="space-y-8">
    ...
    rounded-2xl p-5 shadow-sm hover:shadow-md transition flex items-center gap-5">
            ...
            @class([
                'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-300' => $this->event['event']['status'] === 'upcoming',
                'bg-sky-50 dark:bg-sky-900/30 text-sky-600 dark:text-sky-300' => $this->event['event']['status'] === 'ongoing',
                'bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-400' => $this->event['event']['status'] === 'finished',
            ])
        ">
        ...
        <div class="overflow-x-auto rounded-lg border border-zinc-200 dark:border-zinc-800">
            <table class="min-w-full text-sm text-left text-gray-600 dark:text-gray-300">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-100 dark:border-zinc-800 hover:bg-gray-50 dark:hover:bg-zinc-800/50 transition">
                        ...
                        <td class="px-6 py-3">
                            <span class="px-2 py-1 rounded-full text-xs font-medium
                                        @class([
                                            'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300' => $guest['status'] === 'checked_in',
                                            'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-300' => $guest['status'] === 'invited',
                                            'bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-400' => $guest['status'] === 'cancelled',
                                        ])
                                    ">
