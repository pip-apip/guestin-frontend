<div role="status" id="toaster" style="z-index: 99999 !important;" x-data="toasterHub(@js($toasts), @js($config))" @class([
    'fixed p-4 z-[999999] w-full flex flex-col pointer-events-none sm:p-6',
    ...
    <template x-for="toast in toasts" :key="toast.id">
        <div x-show="toast.isVisible"
             ...
             @class(['relative z-[99999] duration-300 transform transition ease-in-out max-w-xs w-full pointer-events-auto', 'text-center' => $position->is('center')])
